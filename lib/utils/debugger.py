...
class Debugger(object):
  def __init__(self, ipynb=False, theme='black', 
    ...
    #mehdi
    elif num_classes == 5 or dataset == 'shape':
        self.names= shape_class_name
    #elif num_classes == 3 or dataset == 'shape':
    #    self.names= shape_class_name_three
    elif dataset == 'gta':
...
#Mehdi
shape_class_name = ['square', 'circle', 'triangle', 'hexagon', 'eclipse']
shape_class_name_three = ['square', 'circle', 'triangle']
