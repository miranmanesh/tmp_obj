...
from models.decode import Maskct_decode
...
class CtdetDetector(BaseDetector):
  ...
  def process(self, images, return_time=False):
    with torch.no_grad():
      #self.model = torch.load('/home/mehdi/CenterNet-master/src/model_last(multicombined-500ep).pth')
      ...
      dets = Maskct_decode(pred_masks,pred_centers,pred_widths,pred_heights)
